...
import static me.scana.okgradle.internal.dsl.api.ext.GradlePropertyModel.ValueType.NONE;
...
import me.scana.okgradle.internal.dsl.model.dependencies.*;
...
public class DependenciesModelImpl extends GradleDslBlockModel implements DependenciesModel {
  ...
  private interface Fetcher<T extends DependencyModel> {
    ...
    void fetch(@NotNull String configurationName,
               ...
               @NotNull me.scana.okgradle.internal.dsl.model.dependencies.DependencyModelImpl.Maintainer maintainer,
  ...
  enum Maintainers implements me.scana.okgradle.internal.dsl.model.dependencies.DependencyModelImpl.Maintainer {
    ...
    EXPRESSION_LIST_MAINTAINER {
      @NotNull
      @Override
      public me.scana.okgradle.internal.dsl.model.dependencies.DependencyModelImpl.Maintainer setConfigurationName(me.scana.okgradle.internal.dsl.model.dependencies.DependencyModelImpl dependencyModel, String newConfigurationName) {
