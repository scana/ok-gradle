...
import me.scana.okgradle.internal.dsl.model.ext.PasswordPropertyModelImpl;
import me.scana.okgradle.internal.dsl.model.ext.ResolvedPropertyModelImpl;
import me.scana.okgradle.internal.dsl.model.ext.SigningConfigPropertyModelImpl;
import me.scana.okgradle.internal.dsl.model.ext.transforms.PropertyTransform;
import me.scana.okgradle.internal.dsl.model.java.LanguageLevelPropertyModelImpl;
import me.scana.okgradle.internal.dsl.parser.elements.FakeElement;
...
public class GradlePropertyModelBuilder {
   ...
   */
  public me.scana.okgradle.internal.dsl.model.ext.GradlePropertyModelImpl build() {
    GradleDslElement currentElement = getElement();
    me.scana.okgradle.internal.dsl.model.ext.GradlePropertyModelImpl model = currentElement == null
                                    ? new me.scana.okgradle.internal.dsl.model.ext.GradlePropertyModelImpl(getParentElement(), myType, myName)
                                    : new me.scana.okgradle.internal.dsl.model.ext.GradlePropertyModelImpl(currentElement);
   ...
   * @return the built model
   */
  public me.scana.okgradle.internal.dsl.model.ext.PasswordPropertyModelImpl buildPassword() {
    GradleDslElement currentElement = getElement();
    me.scana.okgradle.internal.dsl.model.ext.PasswordPropertyModelImpl model = currentElement == null
                                      ? new me.scana.okgradle.internal.dsl.model.ext.PasswordPropertyModelImpl(getParentElement(), myType, myName)
