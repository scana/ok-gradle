...
import me.scana.okgradle.internal.dsl.api.util.TypeReference;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;

/**
 * Represents a {@link me.scana.okgradle.internal.dsl.api.ext.GradlePropertyModel} which will always automatically follow any references when calling
 ...
 * {@link me.scana.okgradle.internal.dsl.api.ext.GradlePropertyModel} which can be obtained using {@link #getUnresolvedModel()} where {@link #getValueType()}
 * and {@link #getValue(TypeReference)} will return REFERENCE and "appId" respectively.
 *
 */
public interface ResolvedPropertyModel extends me.scana.okgradle.internal.dsl.api.ext.GradlePropertyModel {
  /**
  ...
  /**
   * Returns the {@link me.scana.okgradle.internal.dsl.api.ext.GradlePropertyModel} representing this property.
   */
  @Override
  @NotNull
  me.scana.okgradle.internal.dsl.api.ext.GradlePropertyModel getUnresolvedModel();
   ...
   * Then calling {@link me.scana.okgradle.internal.dsl.api.ext.GradlePropertyModel#resolve()} to obtain the resolved model. This model represents the carColour property
