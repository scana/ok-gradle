...
public interface GradleBuildModel extends me.scana.okgradle.internal.dsl.api.GradleFileModel {
  /**
  ...
  @NotNull
  List<me.scana.okgradle.internal.dsl.api.PluginModel> plugins();
