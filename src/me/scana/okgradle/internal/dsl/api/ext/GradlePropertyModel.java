...
public interface GradlePropertyModel {
  ...
  TypeReference<me.scana.okgradle.internal.dsl.api.ext.ReferenceTo> REFERENCE_TO_TYPE = new TypeReference<ReferenceTo>() {};
  ...
  /**
   * @return the {@link me.scana.okgradle.internal.dsl.api.ext.PropertyType} of the property.
   */
  @NotNull
