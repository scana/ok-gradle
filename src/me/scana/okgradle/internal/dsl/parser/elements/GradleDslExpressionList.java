 ...
 */
public final class GradleDslExpressionList extends GradlePropertiesDslElement implements me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression {
  ...
  public GradleDslExpressionList(@Nullable me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement parent, @NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleNameElement name, boolean isLiteralList) {
    super(parent, null, name);
    myAppendToArgumentListWithOneElement = false;
    myIsLiteralList = isLiteralList;
  }

  public GradleDslExpressionList(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement parent,
  ...
  public void addParsedExpression(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression expression) {
    super.addParsedElement(expression);
  }

  public void addNewExpression(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression expression) {
    setNewElement(expression);
  }

  public void addNewExpression(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression expression, int index) {
    addNewElementAt(index, expression);
  }

  @SuppressWarnings("SuspiciousMethodCalls") // We pass in a superclass instance to remove.
  public void removeElement(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement element) {
    super.removeProperty(element);
  }

  public me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression getElementAt(int index) {
    List<me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression> expressions = getPropertyElements(me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression.class);
  ...
  @SuppressWarnings("SuspiciousMethodCalls") // We pass in a superclass instance to remove.
  public int findIndexOf(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement element) {
    List<me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression> expressions = getPropertyElements(me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression.class);
  ...
  void addNewLiteral(@NotNull Object value) {
    me.scana.okgradle.internal.dsl.parser.elements.GradleDslLiteral literal = new GradleDslLiteral(this, myName);
  ...
  public void replaceExpression(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression oldExpression, @NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression newExpression) {
    super.replaceElement(oldExpression, newExpression);
  }

  @NotNull
  public List<me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression> getExpressions() {
    return getPropertyElements(me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression.class);
  }
  ...
  public void setParsedElement(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement element) {
    assert element instanceof me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression;
  ...
  public me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement setNewElement(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement newElement) {
    assert newElement instanceof me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression;
  ...
  public me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement replaceElement(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement oldElement, @NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement newElement) {
    assert newElement instanceof me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression && oldElement instanceof me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression;
