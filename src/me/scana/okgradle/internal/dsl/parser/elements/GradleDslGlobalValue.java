...
public class GradleDslGlobalValue extends GradleDslSimpleExpression {
  ...
  public GradleDslGlobalValue(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement parent, @NotNull Object value) {
    super(parent, null, me.scana.okgradle.internal.dsl.parser.elements.GradleNameElement.fake("fakevalue"), null);
    myFakeValue = value;
  }

  public GradleDslGlobalValue(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement parent, @NotNull Object value, @NotNull String name) {
