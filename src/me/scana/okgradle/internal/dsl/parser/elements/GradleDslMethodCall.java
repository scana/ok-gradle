...
public final class GradleDslMethodCall extends GradleDslSimpleExpression {
   ...
   */
  public GradleDslMethodCall(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement parent, @NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleNameElement name, @NotNull String methodName) {
    super(parent, null, name, null);
    myMethodName = methodName;
    myArguments = new GradleDslExpressionList(this, me.scana.okgradle.internal.dsl.parser.elements.GradleNameElement.empty(), false);
  ...
  public void addNewArgument(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression argument) {
    myArguments.addNewExpression(argument);
  }

  public void replaceArgument(@NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression oldElement, @NotNull me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression newElement) {
  ...
  @NotNull
  public List<me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression> getArguments() {
  ...
  @Nullable
  private Object getValueFromArgList(@NotNull List<? extends me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement> args) {
  ...
  public GradleDslMethodCall copy() {
    ...
    GradleDslMethodCall methodCall = new GradleDslMethodCall(myParent, me.scana.okgradle.internal.dsl.parser.elements.GradleNameElement.copy(myName), myMethodName);

    for (me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression argument : getArguments()) {
      me.scana.okgradle.internal.dsl.parser.elements.GradleDslExpression copy;
      copy = argument.copy();
  ...
  private void setFileValue(@NotNull File file) {
    ...
    if (arguments.isEmpty()) {
      me.scana.okgradle.internal.dsl.parser.elements.GradleDslLiteral argument = new GradleDslLiteral(this, GradleNameElement.empty());
      argument.setValue(file.getPath());
      myArguments.addNewExpression(argument);
      return;
    }

    me.scana.okgradle.internal.dsl.parser.elements.GradleDslElement pathArgument = arguments.get(0);
