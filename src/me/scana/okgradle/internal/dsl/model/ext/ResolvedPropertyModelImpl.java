 ...
 * and just want to get the actual value. Using {@link me.scana.okgradle.internal.dsl.model.ext.GradlePropertyModelImpl} directly can result in having to follow long
 * reference changes in order to get a value.
 */
public class ResolvedPropertyModelImpl implements ResolvedPropertyModel {
  @NotNull protected final me.scana.okgradle.internal.dsl.model.ext.GradlePropertyModelImpl myRealModel;

  public ResolvedPropertyModelImpl(@NotNull me.scana.okgradle.internal.dsl.model.ext.GradlePropertyModelImpl realModel) {
